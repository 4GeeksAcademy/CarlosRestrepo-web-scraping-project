...
# sns.histplot(df_libros['Precio'], bins=10)
# plt.title('Distribución de Precios de los Libros')
# plt.xlabel('Precio (£)')
# plt.ylabel('Número de Libros')
# plt.show()
# Se puede observar como el precio de la mayoría de libros ronda los 50£,
# mientras que también hay un variedad de libros que se posicionan con precios asequibles.
